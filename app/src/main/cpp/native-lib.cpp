...
Java_com_heculess_rtmppush_RecordService_open(JNIEnv *env, jobject instance, jstring url_,
                                              jstring name_) {
...
Java_com_heculess_rtmppush_RecordService_close(JNIEnv *env, jobject instance, jlong rtmpPointer) {
...
Java_com_heculess_rtmppush_RecordService_init_1video_1info(JNIEnv *env, jobject instance,
                                                           jint width, jint height,
                                                           jint color_space, jint fps) {
